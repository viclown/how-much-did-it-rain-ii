...
- Исправила баг (в первой версии пробовала разные эксперименты, в итоговой версии остался eval_set, который раньше использовался для early_stopping, а потом перестал использоваться). n_estimators поставила 10000, но он используется как верхняя граница под early_stopping. 
